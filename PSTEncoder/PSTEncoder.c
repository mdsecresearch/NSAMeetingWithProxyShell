...
byte mpbbCrypt[] =
{
 ...
 // and https://stackoverflow.com/questions/3747086/reading-the-whole-text-file-into-a-char-array-in-c
void main(int argc, char *argv[]){
    ...
    //size_t size = strlen(buffer) + 1; //  If you don't know the source size.
    //char* c = malloc(size);
    //strcpy(c, field);
    int length = strlen(buffer);
    //printf("Input Length: %d\r\n\r\n", length);

    CryptPermute(buffer, length, false);
    printf("Cipher:\r\n%s\r\n\r\n", buffer);
    char* encoded = calloc(1, length * 4 / 3 + 1);
    Base64encode(encoded, buffer, length);
    printf("Cipher - Base64 encoded:\r\n%s\r\n\r\n",encoded);

    CryptPermute(buffer, length, true);
    printf("Decipher:\r\n%s\r\n\r\n", buffer);
